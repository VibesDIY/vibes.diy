...
import type { ImageMsg } from "./image-stream.js";
export type StreamEvent = StatsCollectMsg | FullOutput | LineStreamOutput | BlockOutputMsg | ImageMsg;

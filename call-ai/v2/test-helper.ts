...
// Extract JSON from ```JSON code blocks in block stream output.
// Mirrors srv-sandbox.ts getCodeBlock logic.
...
// Extract text from toplevel lines (for non-codeblock responses).

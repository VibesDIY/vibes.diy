...
export interface VibeInstanceDocument {
  _id?: string; // Auto-generated by Fireproof, used as UUID
  titleId: string; // The vibe slug (e.g., "kanban-board")
  description: string; // User-friendly name (e.g., "My work board")
  userId: string; // Owner user ID
  createdAt: string; // ISO timestamp
  updatedAt: string; // ISO timestamp
  sharedWith: string[]; // Array of user emails/IDs
  options?: Record<string, unknown>; // Flexible metadata
}

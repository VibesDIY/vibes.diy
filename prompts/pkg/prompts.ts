  ...
  properties: {
    ...
    enrichedPrompt: {
      ...
      description: [
        ...
        "Sentence 3: name the things people can add or change in this app, and who changes them — pick the one that fits: for a personal tracker, journal, budget, or log, each person keeps their own and can invite a chosen buddy, partner, or coach to follow it; for a public wall, guestbook, or feed each signed-in visitor adds their own contributions while everyone reads the rest; for an app built around a shared thing a group joins and co-edits (a list, a trip, a team space, a board or canvas people can ask to join) the people who've joined edit the whole thing together and a newcomer can request in. Whichever fits, the editing controls are hidden automatically for people who aren't allowed to use them. If generated pictures are naturally part of the app, add a brief clause naming what a generated illustration would depict.",

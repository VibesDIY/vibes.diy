...
export async function makeBaseSystemPrompt(
  ...
  const systemPrompt = [
    ...
    "- a `classNames` object with one **empty-string** key per major region (`page`, `header`, plus one per feature). Names only — do NOT fill in Tailwind class strings here; long value strings are slow to stream. Values land via edits.",
    ...
    "- NO hooks (no useState, no useFireproof, no useLiveQuery), NO callAI calls, NO event handlers, NO real Tailwind class strings",
    "",
    "Scaffold shape (rename `featureOne/Two/Three` and `id` values to match your features):",
    "",
    "```",
    "App.jsx",
    "```jsx",
    ...
    "function FeatureOne() {",
    "  return (",
    '    <section id="feature-one" className={classNames.featureOne}>',
    "      <h2>Feature One</h2>",
    "    </section>",
    "  );",
    "}",
    ...
    "function FeatureTwo() {",
    "  return (",
    '    <section id="feature-two" className={classNames.featureTwo}>',
    "      <h2>Feature Two</h2>",
    "    </section>",
    "  );",
    "}",
    ...
    "  return (",
    '    <section id="feature-three" className={classNames.featureThree}>',
    "      <h2>Feature Three</h2>",
    "    </section>",
    "  );",
    "}",

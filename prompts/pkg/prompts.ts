  ...
  properties: {
    ...
    enrichedPrompt: {
      ...
      description: [
        ...
        "Sentence 3: name the things people can add or change in this app, and who changes them — pick the one that fits: for most apps each signed-in visitor adds and edits their own contributions while everyone reads the rest; for an app built around inviting people into a shared thing (a list, a trip, a team space) the people brought in edit that shared thing together; for an app genuinely one person's to publish (a blog, an announcements feed) only the owner makes changes and everyone else reads. Whichever fits, the editing controls are hidden automatically for people who aren't allowed to use them. If generated pictures are naturally part of the app, add a brief clause naming what a generated illustration would depict.",

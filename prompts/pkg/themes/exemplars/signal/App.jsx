...
// Theme: Signal — auto-generated exemplar.
// Tokens lifted from the catalog: bg #030303, accent #ffffff.
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Signal theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

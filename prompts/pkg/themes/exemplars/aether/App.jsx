...
// Theme: Aether Brass — auto-generated exemplar.
// Tokens lifted from the catalog: bg #dcbfa6, accent #cfa562.
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Aether Brass theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

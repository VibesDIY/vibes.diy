...
// Theme: Zine Cut — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.96 0.005 100), accent oklch(0.05 0 0).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Zine Cut theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

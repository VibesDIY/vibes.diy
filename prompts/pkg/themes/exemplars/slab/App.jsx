...
// Theme: Slab Concrete — auto-generated exemplar.
// Tokens lifted from the catalog: bg #fff, accent oklch(0.88 0.000 0).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Slab Concrete theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

...
// Theme: Rune Interface — auto-generated exemplar.
// Tokens lifted from the catalog: bg #fff, accent #020406.
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Rune Interface</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Rune Interface theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

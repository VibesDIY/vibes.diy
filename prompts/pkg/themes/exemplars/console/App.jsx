...
// Theme: Console Rack — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.93 0.003 265), accent oklch(0.58 0.20 35).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Console Rack theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

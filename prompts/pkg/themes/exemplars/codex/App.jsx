...
// Theme: Elder Codex — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.06 0.000 0), accent oklch(0.17 0.000 0).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Elder Codex theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

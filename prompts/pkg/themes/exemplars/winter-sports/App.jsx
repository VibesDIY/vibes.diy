...
// Theme: Winter Sports — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.99 0.003 240), accent oklch(0.55 0.19 250).
...
export default function App() {
  ...
  const c = {
    ...
    badge: {
      ...
      borderRadius: 999,
      background: "oklch(0.55 0.19 250)",
      color: "#fafafa",
      fontWeight: 600,
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Winter Sports theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

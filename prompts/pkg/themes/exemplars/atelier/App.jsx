...
// Theme: Atelier Studio — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.95 0.03 70), accent oklch(0.65 0.18 55).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Atelier Studio theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

...
// Theme: Poster — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.11 0.01 270), accent oklch(0.65 0.18 290).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Poster</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Poster theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

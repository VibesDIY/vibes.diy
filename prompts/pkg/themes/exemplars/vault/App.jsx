...
// Theme: Vault — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.08 0.03 280), accent oklch(0.72 0.15 75).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Vault</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Vault theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

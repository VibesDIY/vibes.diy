...
// Theme: Hearth Sim — auto-generated exemplar.
// Tokens lifted from the catalog: bg #fff, accent oklch(0.38 0.17 295).

export default function App() {
  useEffect(() => {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = "https://fonts.googleapis.com/css2?family=Nunito:wght@400;500;700&display=optional";
  ...
  const c = {
    ...
    badge: {
      ...
      borderRadius: 999,
      background: "oklch(0.38 0.17 295)",
      color: "#fafafa",
      fontWeight: 600,
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Hearth Sim</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Hearth Sim theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

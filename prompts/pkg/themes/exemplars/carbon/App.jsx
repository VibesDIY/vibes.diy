...
// Theme: Carbon Panel — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.18 0.005 285), accent oklch(0.79 0.18 75).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Carbon Panel theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

...
// Theme: Proof Sheet — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.14 0.000 0), accent oklch(1.00 0.000 0 / 0.1).
...
export default function App() {
  ...
  const c = {
    ...
    badge: {
      ...
      borderRadius: 999,
      background: "oklch(1.00 0.000 0 / 0.1)",
      color: "#0a0a0a",
      fontWeight: 600,
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Proof Sheet</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Proof Sheet theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

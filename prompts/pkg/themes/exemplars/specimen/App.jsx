...
// Theme: Specimen — auto-generated exemplar.
// Tokens lifted from the catalog: bg #fff, accent #666.
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Specimen</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Specimen theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

...
// Theme: Sensor Dashboard — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.10 0.003 264), accent oklch(0.53 0.22 25).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Sensor Dashboard theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

...
// Theme: Archive — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.95 0.01 70), accent oklch(0.35 0.04 50).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Archive theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

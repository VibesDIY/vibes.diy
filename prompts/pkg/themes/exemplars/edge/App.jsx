...
// Theme: EDGE INTERFACE — auto-generated exemplar.
// Tokens lifted from the catalog: bg #fff, accent #ff0077.
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>EDGE INTERFACE</h1>
          <p style={c.subtitle}>
            An exemplar app built on the EDGE INTERFACE theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

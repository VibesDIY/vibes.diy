...
// Theme: Guild Ledger — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.10 0.03 260), accent oklch(0.60 0.13 80).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Guild Ledger</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Guild Ledger theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

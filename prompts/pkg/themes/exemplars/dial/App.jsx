...
// Theme: Dial Apparatus — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.24 0.01 260), accent oklch(0.62 0.24 28).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Dial Apparatus</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Dial Apparatus theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

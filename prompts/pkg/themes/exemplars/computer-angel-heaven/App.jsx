...
// Theme: Computer Angel Heaven — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.96 0.008 80), accent oklch(0.78 0.12 85).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Computer Angel Heaven theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

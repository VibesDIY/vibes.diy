...
// Theme: Capsule Split — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.89 0.20 110), accent oklch(0.00 0 0).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Capsule Split theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

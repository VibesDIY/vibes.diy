...
// Theme: Chrono — auto-generated exemplar.
// Tokens lifted from the catalog: bg #dde1e7, accent #6c8ee6.
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Chrono theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

...
// Theme: Dossier Card — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.16 0.000 0), accent #666.

export default function App() {
  useEffect(() => {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = "https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@400;500;700&display=optional";
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Dossier Card</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Dossier Card theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

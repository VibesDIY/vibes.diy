...
// Theme: Desktop Retro — auto-generated exemplar.
// Tokens lifted from the catalog: bg #fff, accent oklch(0.11 0.01 250).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Desktop Retro theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

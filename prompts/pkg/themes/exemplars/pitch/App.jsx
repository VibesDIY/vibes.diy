...
// Theme: Pitch — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.22 0.05 163), accent oklch(0.86 0.18 90).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Pitch</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Pitch theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

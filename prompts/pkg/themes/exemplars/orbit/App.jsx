...
// Theme: Orbit Dashboard — auto-generated exemplar.
// Tokens lifted from the catalog: bg #fff, accent oklch(0.79 0.21 152).
...
export default function App() {
  ...
  const c = {
    ...
    badge: {
      ...
      borderRadius: 999,
      background: "oklch(0.79 0.21 152)",
      color: "#fafafa",
      fontWeight: 600,
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Orbit Dashboard</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Orbit Dashboard theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

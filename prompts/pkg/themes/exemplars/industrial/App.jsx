...
// Theme: Industrial — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.88 0.01 90), accent oklch(0.90 0.20 110).
...
export default function App() {
  ...
  const c = {
    ...
    badge: {
      ...
      borderRadius: 999,
      background: "oklch(0.90 0.20 110)",
      color: "#fafafa",
      fontWeight: 600,
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Industrial</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Industrial theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

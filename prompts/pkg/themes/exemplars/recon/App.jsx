...
// Theme: Recon Grid — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.00 0.000 0), accent oklch(0.64 0.24 25).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Recon Grid</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Recon Grid theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

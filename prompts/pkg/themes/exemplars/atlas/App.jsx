...
// Theme: Atlas Reference — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(1.00 0 0), accent oklch(0.62 0.24 25).
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <p style={c.subtitle}>
            An exemplar app built on the Atlas Reference theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

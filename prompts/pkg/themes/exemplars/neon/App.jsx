...
// Theme: Neon Arcade — auto-generated exemplar.
// Tokens lifted from the catalog: bg #fff, accent #f93c94.

export default function App() {
  useEffect(() => {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = "https://fonts.googleapis.com/css2?family=Rajdhani:wght@400;500;700&display=optional";
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Neon Arcade</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Neon Arcade theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

...
// Theme: Rift Portal — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.07 0.02 280), accent oklch(0.88 0.27 128).

export default function App() {
  useEffect(() => {
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = "https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500;700&display=optional";
  ...
  const c = {
    ...
    badge: {
      ...
      borderRadius: 999,
      background: "oklch(0.88 0.27 128)",
      color: "#0a0a0a",
      fontWeight: 600,
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Rift Portal</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Rift Portal theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

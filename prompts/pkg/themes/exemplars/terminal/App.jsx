...
// Theme: Terminal CRT — auto-generated exemplar.
// Tokens lifted from the catalog: bg oklch(0.16 0.000 0), accent oklch(0.00 0.000 0 / 0.85).
...
export default function App() {
  ...
  const c = {
    ...
    badge: {
      ...
      borderRadius: 999,
      background: "oklch(0.00 0.000 0 / 0.85)",
      color: "#0a0a0a",
      fontWeight: 600,
    ...
    <main id="app" style={c.page}>
      <div style={c.container}>
        <header style={c.header}>
          ...
          <h1 style={c.title}>Terminal CRT</h1>
          <p style={c.subtitle}>
            An exemplar app built on the Terminal CRT theme — list, form, and buttons rendered with the catalog tokens.
          </p>
        </header>

...
export function ImgGenError({ message, className, classes = defaultClasses }: Partial<ImgGenErrorProps>) {
  return (
    <div className={combineClasses("imggen-error-container", className, classes.error)} style={imgGenStyles.error}>

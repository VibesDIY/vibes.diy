...
function MountDemo({ 
          ...
          if (containerRef.current) {
            control = mountVibeControl({
              ...
              children: React.createElement(
                ...
                React.createElement("p", {}, "This VibeControl was mounted using mountVibeControl() to a specific container element."),
                React.createElement(
                  "div",
                  { 
                    style: { 
        ...
        case "body":
          control = mountVibeControlToBody({
            ...
            children: React.createElement(
              ...
              React.createElement("p", {}, "This VibeControl was mounted using mountVibeControlToBody()."),
              React.createElement(
                "div",
                { 
                  style: { 
        ...
        case "auto":
          ...
          (window as any).VIBE_CONTROL_CONFIG = {
            ...
            children: React.createElement(
              ...
              React.createElement("p", {}, "This VibeControl was auto-mounted using global configuration."),
              React.createElement(
                "div",
                { 
                  style: { 
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "600px" }}>
      <h3>{mountType === "container" ? "Container" : mountType === "body" ? "Body" : "Auto"} Mount Example</h3>
        ...
        <div style={{ marginTop: "16px", padding: "12px", backgroundColor: "#f0f8ff", borderRadius: "4px" }}>
          ...
          {mountType !== "container" && (
            <p style={{ margin: "8px 0 0 0", fontSize: "0.9em", color: "#666" }}>
              Look for the floating button positioned on the {mountType === "body" ? "page" : "screen"}
            </p>
          )}
        </div>
      )}
...
const meta: Meta<{ mountType: "container" | "body" | "auto"; options?: Partial<MountVibeControlOptions> }> = {
...
export default meta;
type Story = StoryObj<{ mountType: "container" | "body" | "auto"; options?: Partial<MountVibeControlOptions> }>;

...
vi.mock("use-fireproof", async (importOriginal) => {
  ...
  return {
    ...
    // )),
    // ImgVibesDisplay: vi.fn().mockImplementation((opts) => {
...
import { ImgVibesDisplay } from "@vibes.diy/base";
...
describe("ImgVibesDisplay Component", () => {
  ...
  it("should add title attribute with prompt text to the root element", () => {
    ...
    const { container } = render(<ImgVibesDisplay document={mockDoc} className="test-class" alt="Test alt text" />);
  ...
  it("should use alt text as title when prompt is not available", () => {
    ...
    const { container } = render(<ImgVibesDisplay document={mockDoc} className="test-class" alt="Alternative description text" />);
  ...
  it("should use default text as title when neither prompt nor alt is provided", () => {
    ...
    const { container } = render(<ImgVibesDisplay document={mockDoc} className="test-class" />);
  ...
  it("should handle complex document structure with versioned prompts", () => {
    ...
    const res = render(<ImgVibesDisplay document={mockDoc} className="test-class" />);

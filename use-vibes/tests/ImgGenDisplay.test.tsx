...
describe("ImgGenDisplay Component", () => {
  ...
  it("should add title attribute with prompt text to the root element", () => {
    ...
    const { container } = render(<ImgGenDisplay document={mockDoc} className="test-class" alt="Test alt text" />);
  ...
  it("should use alt text as title when prompt is not available", () => {
    ...
    const { container } = render(<ImgGenDisplay document={mockDoc} className="test-class" alt="Alternative description text" />);

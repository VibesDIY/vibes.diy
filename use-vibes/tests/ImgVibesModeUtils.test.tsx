...
import { getImgVibesMode } from "@vibes.diy/base/components/ImgVibesUtils/ImgVibesModeUtils.js";
import type { PartialImageDocument } from "@vibes.diy/base";

describe("ImgVibesModeUtils", () => {
  describe("getImgVibesMode", () => {
    // Test data helpers

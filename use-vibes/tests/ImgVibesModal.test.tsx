...
import { ImgVibesModal, ImgVibesModalProps } from "@vibes.diy/base";
import type { DocFileMeta } from "use-fireproof";

// Mock AsyncImg component
vi.mock("@vibes.diy/base/components/ImgVibesUtils/AsyncImg.js", () => ({
...
describe("ImgVibesModal Component", () => {
  let mockFile: DocFileMeta;
  let mockProps: ImgVibesModalProps;
  ...
  it("should render modal when isOpen is true", () => {
    const res = render(<ImgVibesModal {...mockProps} />);
  ...
  it("should not render modal when isOpen is false", () => {
    const { container } = render(<ImgVibesModal {...mockProps} isOpen={false} />);
  ...
  it("should call handlePrevVersion when previous button is clicked", () => {
    const res = render(<ImgVibesModal {...mockProps} versionIndex={1} />);

...
import { ImgVibes, useFireproof } from "use-vibes";
import "./App.css";
...
function ImgVibesExample() {
  ...
  const { useLiveQuery } = useFireproof("ImgVibes");
  ...
  const handleGenerate = (e?: React.FormEvent) => {
    ...
    // Set the active prompt that gets passed to ImgVibes only when button is clicked
...
export default ImgVibesExample;

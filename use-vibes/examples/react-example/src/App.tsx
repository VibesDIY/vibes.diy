    ...
    <div className="container">
      ...
      >
        ...
        <p style={{ margin: "0", color: "#666", lineHeight: "1.5" }}>
          Use Vibes is a library that transforms any DOM element into an AI-powered micro-app. These examples demonstrate various
          components and patterns you can use in your applications.
        </p>
      </div>
    </div>
  );

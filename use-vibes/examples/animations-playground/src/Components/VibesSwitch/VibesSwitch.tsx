...
import { getVibesContentStyle, getVibesSvgStyle, switchColors } from './VibesSwitch.styles';
...
export function VibesSwitch({ size = 24, className }: VibesSwitchProps) {
  ...
  return (
    <svg
      ...
      fill="currentColor"
      className={className}
      style={getVibesSvgStyle(entered)}
    ...
    >
      ...
      <path
        ...
        clipRule="evenodd"
        style={{
          ...getVibesContentStyle(showLetters, '0.5s'),
          transition: `fill 0.6s ease, ${getVibesContentStyle(showLetters, '0.5s').transition}`,
      ...
      <path
        ...
        clipRule="evenodd"
        style={{
          ...getVibesContentStyle(showLetters, '0.8s'),
          transition: `fill 0.6s ease, ${getVibesContentStyle(showLetters, '0.8s').transition}`,
          fill: active ? switchColors.primary : switchColors.secondary,
        }}
      ...
      <path
        ...
        clipRule="evenodd"
        style={{
          ...getVibesContentStyle(showLetters, '1.2s'),
          transition: `fill 0.6s ease, ${getVibesContentStyle(showLetters, '1.2s').transition}`,
          fill: active ? switchColors.primary : switchColors.secondary,
        }}
      ...
      <path
        ...
        clipRule="evenodd"
        style={{
          ...getVibesContentStyle(showLetters, '0.6s'),
          transition: `fill 0.6s ease, ${getVibesContentStyle(showLetters, '0.6s').transition}`,
          fill: active ? switchColors.primary : switchColors.secondary,
        }}
      ...
      <path
        ...
        clipRule="evenodd"
        style={{
          ...getVibesContentStyle(showLetters, '1.3s'),
          transition: `fill 0.6s ease, ${getVibesContentStyle(showLetters, '1.3s').transition}`,
          fill: active ? switchColors.primary : switchColors.secondary,
        }}
      ...
      <path
        ...
        clipRule="evenodd"
        style={{
          ...getVibesContentStyle(showLetters, '1s'),
          transition: `fill 0.6s ease, ${getVibesContentStyle(showLetters, '1s').transition}`,

...
metadata:
  github-path: skills/openrouter-typescript-sdk
  github-ref: refs/heads/main
  github-repo: https://github.com/OpenRouterTeam/skills
  github-tree-sha: ad4a590ddaa69ef9dc295a300a76bd451cab650a
...
const searchTool = tool({
  ...
  execute: async ({ query }) => {
    ...
    return {
      results: [{ title: "Example", snippet: "Example result", url: "https://example.com" }],
    };
  },
});

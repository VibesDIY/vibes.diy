...
| ------------------------------------- | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Class-count collapse (3→1 vs 3→2)** | **Defer — prototype lazy-load first, decide with data**                                  | The lazy-load's verifiability (does a lean instance reliably avoid QuickJS parse?) is what de-risks one choice over the other. Land Phase A and its verification, then decide.                                                                                                         |

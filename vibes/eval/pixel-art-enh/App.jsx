...
function CanvasArea() {
  return (
    <section id="canvas" className="bg-[oklch(1_0_0)] border-2 border-[oklch(0.15_0.02_280)] rounded p-3 shadow-[4px_4px_0_oklch(0.15_0.02_280)]">
...
function PaletteBar({ usedColors, color, setColor, viewer, database }) {
  ...
  return (
    <section id="palette" className="bg-[oklch(0.85_0.18_85)] border-2 border-[oklch(0.15_0.02_280)] rounded p-3 shadow-[4px_4px_0_oklch(0.15_0.02_280)]">
      <div className="flex items-center justify-between mb-2">
        ...
        >
          {loading ? (
            <svg className="animate-spin" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="9" strokeDasharray="40 20"/></svg>
          ) : (
...
function LayersPanel({ painters, hiddenLayers, setHiddenLayers, ViewerTag, viewer, database, pixels }) {
  ...
  return (
    <section id="layers" className="bg-[oklch(0.62_0.19_145)] border-2 border-[oklch(0.15_0.02_280)] rounded p-3 shadow-[4px_4px_0_oklch(0.15_0.02_280)]">
      ...
      <ul className="space-y-2">
        {painters.map((handle) => (
          <li key={handle} className="flex items-center justify-between bg-[oklch(1_0_0)] border-2 border-[oklch(0.15_0.02_280)] rounded px-2 py-2 min-h-[44px]">
  ...
  return (
    <>
      ...
      <main id="app" className="min-h-screen bg-[oklch(0.96_0.01_90)] text-[oklch(0.15_0.02_280)] pb-24">
        <header id="app-header" className="sticky top-0 z-10 bg-[oklch(0.55_0.24_28)] border-b-2 border-[oklch(0.15_0.02_280)] px-4 py-3 flex items-center justify-between shadow-[0_4px_0_oklch(0.15_0.02_280)]">
        ...
        <div className="max-w-md mx-auto p-4 space-y-4">
          ...
          <LayersPanel painters={painters} hiddenLayers={hiddenLayers} setHiddenLayers={setHiddenLayers} ViewerTag={ViewerTag} viewer={viewer} database={database} pixels={pixels} />
        </div>
      </main>
    </>
  )

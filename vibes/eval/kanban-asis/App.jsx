...
function ColumnSection({ col, isOwner, viewer }) {
  const c = {
    section: "flex-1 min-w-[260px] md:min-w-0 bg-[oklch(0.27_0.055_163)] border border-[oklch(0.39_0.065_165)] rounded-2xl p-3 flex flex-col gap-3",
    ...
    addBtn: "min-h-[44px] mt-auto w-full bg-[oklch(0.86_0.18_90)] text-[oklch(0.20_0.04_163)] font-semibold rounded-xl active:scale-[0.98] transition",
...
export default function App() {
  ...
  if (isViewerPending) return <div className={c.page}><div className={c.pending}>Loading…</div></div>

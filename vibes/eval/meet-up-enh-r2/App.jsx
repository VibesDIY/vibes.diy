...
function OrganizerDashboard({ database }) {
  ...
  const c = {
    ...
    confirmBtn: "min-h-[44px] px-3 border border-white text-white text-xs font-['Archivo_Black'] tracking-wider hover:bg-white hover:text-black disabled:opacity-40",
  }
              ...
              {windows.map((w, i) => (
                <div key={i} className={c.win}>
                  <div className="flex-1">
                    ...
                    <p className="text-white/50 text-xs mt-1">{w.coverage}/{subs.length} free</p>
                  </div>

  ...
  return (
    <section id="schedule" className="px-4 py-3 border-b border-[var(--border)]">
      ...
      <form onSubmit={onSubmit} className="grid grid-cols-1 gap-2">
        ...
        <button
          type="submit"
          className="min-h-[44px] rounded-lg bg-[var(--accent-green)] text-[oklch(0.18_0.10_300)] font-bold"
        >
          Add Game
        </button>
      </form>
        ...
        {gameSignups.length === 0 ? (
          ...
          <ul className="space-y-1 mb-2">
            {gameSignups.map((s) => {
              ...
              return (
                <li key={s._id} className="flex items-center justify-between gap-2 bg-[oklch(0.18_0.10_300/0.4)] rounded-lg px-3 py-2">
...
export default function App() {
  ...
  const c = {
    ...
    header: "sticky top-0 z-10 backdrop-blur bg-[oklch(0.18_0.10_300/0.85)] border-b border-[var(--border)] px-4 py-3 flex items-center justify-between",

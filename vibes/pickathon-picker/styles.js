...
export const c = {
  ...
  signInCallout:
    "bg-[#181a20] text-white w-full sm:w-auto min-h-[60px] px-[16px] py-2 flex items-center gap-2 rounded-2xl shadow-2xl text-[11px] font-bold border border-white/20 text-balance leading-snug",
};

...
// `token.ts` (upstream tag fireproof-storage/fireproof@core@v0.24.19). Only the
// `ClerkClaim` import was repointed from @fireproof/core-types-base to the owned
// ../../clerk-claim.js. No type shapes changed.
import { Result } from "@adviser/cement";
import { DashAuthType, User } from "./msg-types.js";
import { ClerkClaim } from "../../clerk-claim.js";

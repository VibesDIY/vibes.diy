...
// `msg-types.ts` (upstream tag fireproof-storage/fireproof@core@v0.24.19). Only
// the two cross-package type imports were repointed to owned modules:
//   @fireproof/core-types-base            -> ../../clerk-claim.js (ClerkEmailTemplateClaim)
//                                            ../../types/wire.js  (JWKPublic)
//   @fireproof/core-types-protocols-cloud -> ../protocols-cloud-types.js
// No type shapes changed.
import { ClerkEmailTemplateClaim } from "../../clerk-claim.js";
import { JWKPublic } from "../../types/wire.js";
import { FPCloudClaim, ReadWrite, Role, TenantLedger } from "../protocols-cloud-types.js";

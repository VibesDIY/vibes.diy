import { ImgVibesOptions } from "call-ai";
 ...
 */
export function hashInput(prompt: string, options?: ImgVibesOptions): string {
 ...
 */
export function getRelevantOptions(options?: ImgVibesOptions): Record<string, unknown> {
  if (!options) return {};

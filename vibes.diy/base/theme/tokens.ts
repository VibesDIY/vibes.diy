/**
 * Vibes Design System - Color Tokens as JS objects
 *
 * Single source of truth for all CSS custom properties.
 * Previously defined in theme.css / colors.css / css-variables.css.
 */
...
export const semanticColorsLight: Record<string, string> = {
  // Backgrounds
...
export const semanticColorsDark: Record<string, string> = {
  // Backgrounds

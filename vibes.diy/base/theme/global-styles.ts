/**
 * Global resets, keyframe animations, and utility classes.
 * Internal module — assembled into a CSS string by theme/index.ts.
 */
...
export function buildGlobalCSS(): string {
  return [generateCSSVariables(), resets, keyframes, utilityClasses].join("\n\n");
}

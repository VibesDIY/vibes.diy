...
import { defaultClasses, ImgVibesClasses } from "../../utils/style-utils.js";

export interface ImgVibesModalProps {
    ...
    >
      ...
      >
        {error ? (
          ...
          >
            <ImgVibesError message={error.message} />
          </div>
        ) : (
          <AsyncImg
            file={currentFile}

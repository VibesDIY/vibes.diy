...
export function VibesPanel({
  ...
  return (
    <div style={VibesPanelStyles.getOuterContainerPanelStyle(style)} className={className}>
      <LabelContainer label="Settings" disappear>
        <div style={VibesPanelStyles.getButtonContainerPanelStyle()}>
          {mode === "mutate" ? (
            // Mutate mode buttons
            <>
            ...
            <>
              {inviteStatus === "idle" ? (
                // Show form when idle
                <form onSubmit={handleInviteSubmit} style={VibesPanelStyles.getInviteFormPanelStyle()}>
                  <label htmlFor={emailId} style={VibesPanelStyles.getInviteLabelPanelStyle()}>
                    Invite by email
                  </label>
                  <BrutalistCard size="md" style={VibesPanelStyles.getInviteInputWrapperPanelStyle()}>
                    <input
                      id={emailId}
                      type="email"
                      ...
                      style={VibesPanelStyles.getInviteInputStyle()}
                      autoComplete="email"
                      required
                    />
                  </BrutalistCard>
                ...
                <BrutalistCard
                  ...
                  style={VibesPanelStyles.getInviteStatusStyle()}
                >

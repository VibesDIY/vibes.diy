/**
 * VibesSwitch Component
 *
 * An animated SVG toggle switch for the Vibes menu
 */

import React from "react";
import { switchColors } from "./VibesSwitch.styles";
import type { VibesSwitchProps } from "./VibesSwitch.types";

export const VibesSwitch: React.FC<VibesSwitchProps> = ({
  size = 24,
  className,
  isActive,
  onToggle,
...
VibesSwitch.displayName = 'VibesSwitch';

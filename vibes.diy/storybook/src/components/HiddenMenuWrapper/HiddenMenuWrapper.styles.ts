...
export const getDevIndicatorStyle = (): CSSProperties => ({
  position: "fixed",
  top: "16px",
  right: "16px",
  zIndex: hiddenMenuTheme.zIndex.menu + 1,
  width: "40px",
  height: "40px",
  backgroundColor: "var(--vibes-yellow-accent)",
...
export const getButtonDevIndicatorStyle = (): CSSProperties => ({
  position: "fixed",
  top: "16px",
  right: "16px",
  width: "40px",
  ...
  fontWeight: 700,
  color: "var(--vibes-near-black)",
  zIndex: hiddenMenuTheme.zIndex.content + 1,
  boxShadow: "0 2px 8px rgba(0, 0, 0, 0.2)",
  cursor: "pointer",
  transition: "transform 0.2s ease, box-shadow 0.2s ease",
});

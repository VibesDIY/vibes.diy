...
if (process.argv[1] && fileURLToPath(import.meta.url) === resolve(process.argv[1])) {
  const { modules, reactVersion } = await buildSsrIsolateDepModules();
  ...
  console.log(`Wrote ssr-isolate-deps.generated.js — React ${reactVersion}, ${Object.keys(modules).length} modules, ${(bytes / 1024).toFixed(0)}KB`);
}

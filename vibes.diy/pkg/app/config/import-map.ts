...
export function getLibraryImportMap() {
  return {
    ...
    "use-fireproof": `https://esm.sh/use-vibes@${VIBES_VERSION}?deps=react@19.2.1,react-dom@19.2.1`,
    "call-ai": `https://esm.sh/call-ai@${VIBES_VERSION}?deps=react@19.2.1`,
    "use-vibes": `https://esm.sh/use-vibes@${VIBES_VERSION}?deps=react@19.2.1,react-dom@19.2.1`,
    "https://esm.sh/use-fireproof": `https://esm.sh/use-vibes@${VIBES_VERSION}?deps=react@19.2.1,react-dom@19.2.1`,
    "https://esm.sh/use-vibes": `https://esm.sh/use-vibes@${VIBES_VERSION}?deps=react@19.2.1,react-dom@19.2.1`,
  };
}

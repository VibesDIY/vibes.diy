...
import { LoginIcon, SettingsIcon } from "../../components/vibes/icons/index.js";

// Helper function for asset paths - allows dynamic root if needed later
const asset = (name: string) => `/homepage/${name}`;
...
export const HomeScreen = (_props: HomeScreenProps) => {
  ...
  // Use browser's prefers-color-scheme for dark mode
  const isDarkMode = browserPrefersDark;
              ...
              <>
                ...
                <DraggableCard color="yellow" x={1000} y={1700}>
                  <p style={getImageCardStyle()}>
                    <img
                      src={asset("rainbow-computer.gif")}
                      style={getFullSizeImageStyle()}
                    />
                  </p>
                </DraggableCard>
                ...
                <DraggableCard color="yellow" x={700} y={7000}>
                  <img
                    style={getImageCardStyleSmall("340px")}
                    src={asset("mouth.gif")}
                  />
                </DraggableCard>
              </>
              ...
              >
                {/* <div style={get1of3Column(isMobile)}>
                  <DraggableSection color="blue" static removeMargin>
                    <img src={asset("vibes-stack.png")} style={{ flex: "100%" }} />
                  </DraggableSection>
                </div> */}

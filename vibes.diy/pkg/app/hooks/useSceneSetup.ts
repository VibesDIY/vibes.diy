...
const bonsaiImg = asset("screenshots/bonsai.png");
const deasImg = asset("screenshots/deas.png");
const encryptImg = asset("screenshots/encrypt.png");
const pickathonImg = asset("screenshots/pickathon.png");
const puzzleImg = asset("screenshots/puzzle.png");

...
const categories: Category[] = [
  ...
  },
  {
    label: "Productive",
    prompts: [
      "Brain dump — type anything, AI parses it into tagged task items and sorts them into your lists; keep a list private or invite someone to share it.",
      "Pomodoro dashboard with multiple concurrent timers, break reminders, and session stats that survive refresh.",
      "Schedule smasher — invite people to a shared poll to mark when they're free, AI instantly spots the best overlap.",
      "Compound interest visualizer with student loan payoff curves and retirement countdown.",
      "Habit streak tracker — daily check-ins, flame streaks, and the option to share a streak with an accountability buddy who cheers you on.",
      "Kanban board your team can join and co-edit, with buttery drag-and-drop across To Do, Doing, and Done columns.",
      "Shared meeting notes the whole call contributes to — bullet-point capture together, AI summary at the end.",
      "Goal tracker with milestones, a visual progress bar, celebratory animations, and the option to invite a friend or coach to follow along.",
      "Bookmark vault — save links, auto-tag by topic, search everything instantly, and share a collection with others.",
      "Daily journal with a mood picker and AI-generated reflection prompts — private by default, with the option to open an entry to a coach or partner.",
    ],
  },
  {
    label: "Music",
  ...
  },
  {
    ...
    prompts: [
      ...
      "Snake with arrow keys, a growing neon tail, and a shared high-score board everyone competes on.",

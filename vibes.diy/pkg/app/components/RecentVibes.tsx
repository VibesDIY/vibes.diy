  ...
  return (
    <div className="pt-2">
      <Link
        to="/"
        onClick={onNavigate}
        className="flex items-center px-4 py-3 mb-3 text-sm font-medium tracking-wide transition-colors duration-150 hover:bg-black/5 dark:hover:bg-white/10 border-b border-black/10 dark:border-white/10"
      >

      ...
      <div style={containerStyle}>
        <div style={resultStyle}>
          ...
          <p style={summaryStyle}>
            {"You're a "}
            <strong>{superpower}</strong> <strong>{time}</strong>
            {" person who loves "}
            <strong>{tool}</strong>
            {"!"}
          </p>
        ...
        {question.choices.map((choice, idx) => {
          ...
          return (
            <button
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLButtonElement).style.background = "var(--vibes-variant-blue, #3b82f6)";
                (e.currentTarget as HTMLButtonElement).style.color = "var(--vibes-cream, #FFFEF0)";
                (e.currentTarget as HTMLButtonElement).style.borderColor = "var(--vibes-variant-blue, #3b82f6)";
              }}
              onMouseLeave={(e) => {
                if (pressed !== idx) {
                  (e.currentTarget as HTMLButtonElement).style.background = "transparent";
                  (e.currentTarget as HTMLButtonElement).style.color = "var(--vibes-near-black, #1a1a1a)";
                  (e.currentTarget as HTMLButtonElement).style.borderColor = "var(--vibes-near-black, #1a1a1a)";
                }
              }}
            >
              {choice}

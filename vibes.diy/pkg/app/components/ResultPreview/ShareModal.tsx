            ...
            <div className="bg-light-background-01 text-light-secondary dark:bg-dark-decorative-00 dark:text-dark-secondary rounded px-2 py-2 text-sm">
              ...
              <div className="mt-2">
                ...
                <button
                  ...
                  className={cx(
                    "flex w-full items-center justify-between rounded border border-blue-500 bg-transparent px-3 py-1.5 text-xs text-blue-600 hover:bg-blue-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-900/20",
                    isPublishing && stripesOverlay,
                    isPublishing && "animate-gradient-x animate-pulse"
                  )}
                >

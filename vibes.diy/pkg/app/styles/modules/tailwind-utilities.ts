 ...
 * Generated utilities + custom utility classes
 * Includes animation utilities, accent colors, decorative colors, backgrounds
 *
 * Extracted from global-styles.ts lines 437-732
 */

...
**"Sites"** refers to Vibes DIY, accessible from https://vibes.diy, and the other websites, apps, and online services that Vibes DIY indicates are covered by this Policy. Collectively, we refer to Sites, Business Services, and End User Services as "Services."
...
- **User Content.** After registration, you may create, upload, or transmit files, documents, videos, images, data, or information as part of your use of the Service (collectively, "User Content"). User Content and any information contained in it, including personal information you may have included, is stored and collected as part of the Service. You have full control over the information included in the User Content. See "AI and Model Use" below for how prompts and generated apps are handled.
...
- We may receive personal information about you from our business partners and service providers and combine this information with other data we collect from you. These third parties may include website and service operators and payment processors.
...
The Service uses AI to help you generate applications, and we know that "do you train on my data?" is the most important privacy question for a code-generation product. To be clear:

- **We do not use your prompts or generated apps to train large language models (LLMs).** Your User Content is not used to train or fine-tune foundation models, whether ours or third parties'.
- **Generation uses third-party model providers.** To generate code and content, your prompts may be sent to third-party AI model providers operating under data-handling commitments (such as no-training API tiers). Their handling of data is governed by their respective privacy notices.
- **Service improvement.** We may use aggregated and/or de-identified information about how apps are built and how the Service is used — a content-informed feedback loop — to improve the quality of the Service and the applications we help you generate. This does not include using your User Content to train LLMs.
...
We may share your personal information in the following situations. For more information on your choices regarding your information, see "Your Rights and Choices."

- We may share your personal information with third-party service providers or sub-processors who help us deliver or improve our Site or services. They may perform services on our behalf, including processing payments, providing web hosting services, providing AI model inference, or offering analytics. These third parties are subject to reasonable confidentiality terms and may only use the information to provide services to us.
...
- We may share information with other companies and brands owned or controlled by Vibes DIY or under common ownership as Vibes DIY. These companies will use your personal information in the same way as we can under this Privacy Policy.
- We may transfer any information we collect in the event we sell or transfer all or a portion of our business or assets (including in connection with a merger, acquisition, reorganization, financing, or sale of assets, or in the event of bankruptcy or insolvency). In such transactions, your information may be one of the transferred assets, and we will require any acquirer to honor this Policy or provide notice of any material change.

## Data Retention

We retain Personal Data for as long as necessary to provide the Service, maintain your account, comply with our legal obligations, resolve disputes, and enforce our agreements. When Personal Data is no longer needed for these purposes, we will delete or de-identify it. As a data processor, we retain application data on behalf of, and according to the instructions of, the relevant Customer.

## Security

We use commercially reasonable administrative, technical, and organizational measures designed to protect Personal Data against unauthorized access, loss, misuse, or alteration. No method of transmission or storage is completely secure, however, and we cannot guarantee absolute security. Please also review the Security section of our [Terms of Service](/legal/tos) regarding your responsibility to back up and protect Your Content.
...
- **Opt-out** — opt out of non-essential product communications.

To exercise any of these rights, contact us using the details in "How to Contact Us." We will respond within the timeframes required by applicable law and will not discriminate against you for exercising your rights.
...
If you are in the European Economic Area, the United Kingdom, or Switzerland, we process your Personal Data on the legal bases of performance of a contract, our legitimate interests, your consent, and/or compliance with legal obligations. You have the rights described above and the right to lodge a complaint with your local supervisory authority. Where we rely on consent, you may withdraw it at any time.

## International Data Transfers

We are based in the United States and may process and store Personal Data in the United States and other countries. Where required, we use appropriate safeguards (such as Standard Contractual Clauses) for transfers of Personal Data out of the EEA, the UK, or Switzerland.
...
We may update this Policy from time to time. Material changes will be posted on this page with an updated "Last updated" date and, where appropriate, communicated by email or in-product notice.

## How to Contact Us

If you have questions about this Policy or our privacy practices, or wish to exercise your rights, contact us at:

- **Email:** [help@vibes.diy](mailto:help@vibes.diy)

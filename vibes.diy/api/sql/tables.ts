...
function createSqliteVibesApiTables() {
  return {
    ...
    handleSettings: sqlite.sqlHandleSettings,
    ...
    backendFunctionBindings: sqlite.sqlBackendFunctionBindings,
...
export function createVibesApiTables(flavour: DBFlavour): VibesApiTables {
  if (flavour === "pg") {
    return {
      ...
      handleSettings: pg.sqlHandleSettings,
      ...
      backendFunctionBindings: pg.sqlBackendFunctionBindings,

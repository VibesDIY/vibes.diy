  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      ...
      if (window.location.pathname === "/sso-callback") {
        console.error("SSO callback timeout: Clerk did not complete authentication within 3 seconds");
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="text-center">
        ...
        <div className="mt-4 text-sm text-gray-600 dark:text-gray-400">Completing sign in...</div>
      </div>
    </div>
  );
}

...
export const StarIcon: React.FC<SvgIconProps & { filled?: boolean }> = ({ filled = false, className = "h-5 w-5" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export const DataIcon: React.FC<SvgIconProps> = ({ className = "h-3.5 w-3.5 sm:h-4 sm:w-4", title }) => {
  return (
...
export const PublishIcon: React.FC<SvgIconProps> = ({ className = "h-5 w-5" }) => {
  return (
    ...
    >
      ...
      />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 16V2m0 0l-4 4m4-4l4 4" />
    </svg>
  );
};
...
export const MinidiscIcon: React.FC<SvgIconProps> = ({ className = "h-4 w-4", title }) => {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      ...
      <rect x="0.8" y="0.8" width="22.4" height="22.4" rx="3" fill="none" stroke="currentColor" strokeWidth="1.4" />
      {/* Minidisc outline */}
      ...
      {/* Label area */}
      <rect x="16" y="9.5" width="6" height="5" rx="1" fill="none" stroke="currentColor" strokeWidth=".8" />
      {/* Label lines */}

...
import { ScreenshotBoy } from "./ScreenshotBoy";

// Screenshot paths (served from public directory)
const bonsaiImg = "/app/assets/screenshots/bonsai.png";
const deasImg = "/app/assets/screenshots/deas.png";
const encryptImg = "/app/assets/screenshots/encrypt.png";
const pickathonImg = "/app/assets/screenshots/pickathon.png";
const puzzleImg = "/app/assets/screenshots/puzzle.png";
